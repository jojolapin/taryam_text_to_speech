...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      // Voice engine / OpenAI
      'set.engine': 'Engine',
      'engine.piper': 'Piper (offline)',
      'engine.openai': 'OpenAI (online)',
      ...
      'openai.needKey': 'Add your OpenAI API key in Settings to use online voices.',
      'openai.disclosure': 'These voices are generated by AI via OpenAI \u2014 they are not human recordings. Your text is sent to OpenAI to synthesize the audio.',
      'openai.disclosureToast': 'OpenAI voices are AI-generated; your text is sent to OpenAI and usage may incur charges.',
      'settings.openai': 'OpenAI voices',
      'settings.openai.key': 'API key',
      'settings.openai.key.set': 'Set ({src})',
      'settings.openai.key.unset': 'Not set',
      'settings.openai.key.save': 'Save key',
      'settings.openai.key.clear': 'Clear',
      'settings.openai.key.saved': 'OpenAI API key saved.',
      'settings.openai.key.cleared': 'OpenAI API key cleared.',
    ...
    fr: {
      ...
      // Moteur de voix / OpenAI
      'set.engine': 'Moteur',
      'engine.piper': 'Piper (hors ligne)',
      'engine.openai': 'OpenAI (en ligne)',
      ...
      'openai.needKey': 'Ajoutez votre cl\u00e9 API OpenAI dans les R\u00e9glages pour utiliser les voix en ligne.',
      'openai.disclosure': 'Ces voix sont g\u00e9n\u00e9r\u00e9es par IA via OpenAI \u2014 ce ne sont pas des enregistrements humains. Votre texte est envoy\u00e9 \u00e0 OpenAI pour synth\u00e9tiser l\u2019audio.',
      'openai.disclosureToast': 'Les voix OpenAI sont g\u00e9n\u00e9r\u00e9es par IA ; votre texte est envoy\u00e9 \u00e0 OpenAI et l\u2019usage peut engendrer des frais.',
      'settings.openai': 'Voix OpenAI',
      'settings.openai.key': 'Cl\u00e9 API',
      'settings.openai.key.set': 'D\u00e9finie ({src})',
      'settings.openai.key.unset': 'Non d\u00e9finie',
      'settings.openai.key.save': 'Enregistrer la cl\u00e9',
      'settings.openai.key.clear': 'Effacer',
      'settings.openai.key.saved': 'Cl\u00e9 API OpenAI enregistr\u00e9e.',
      'settings.openai.key.cleared': 'Cl\u00e9 API OpenAI effac\u00e9e.',
